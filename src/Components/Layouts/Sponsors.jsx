...
import Castle from '../../Images/castleChurch.png';
    ...
    <div className='container' style={{color:'#fff', marginTop:100}}>
      ...
      <div className='row' style={{marginBottom:200}}>
        ...
        <div className='col-sm'>
          <div className='card' style={{backgroundColor:'transparent'}}>
            <div className='card-body'>
              <a href='http://www.jmeyers.com/' target='_blank' rel='noopener noreferrer'><img className='card-img-top' src={jMyers} alt='jMeyers'/></a>
            </div>
          </div>
        </div>
        <div className='col-sm'>
          <div className='card' style={{backgroundColor:'transparent'}}>
            <div className='card-body'>
              <a href='https://www.castlechurchbrewing.com/' rel='noopener noreferrer' target='_blank'><img className='card-img-top' src={Castle} alt='Castle Church'></img></a>
            </div>
          </div>
        </div>
      </div>
